...
describe("Map tests", function() {
  beforeEach(function() {
		this.globalScope = Scope.getGlobalScope();
  ...
  describe("#run", function() {
    ...
    it("exposes and conceals emit in the window scope", function() {
      ...
      var me = this;
      expect(this.scopeMock.expose).toHaveBeenCalledWith({
    ...
    describe("data grouping", function() {
      var mappedDataExpected = [
        {
          _id: 42,
          value: ["Cornballer", "Uncle Father Oscar", "Dead Dove DO NOT EAT"]
        }
      ];
  ...
  describe("#getEmits", function() {
    ...
    var mockData = [{ first: "foo" }, { first: "bar" }];
    var expectedEmits = [{ _id: 42, value: "foo" }, { _id: 42, value: "bar" }];
